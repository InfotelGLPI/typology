...
xgettext *.php */*.php --copyright-holder='Typology Development Team' --package-name='GLPI - Typology plugin' --package-version='2.3.0' -o locales/glpi.pot -L PHP --add-comments=TRANS --from-code=UTF-8 --force-po  \
