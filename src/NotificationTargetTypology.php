 ...
 */
class NotificationTargetTypology extends NotificationTarget
{
    /**
    ...
    public function addDataForTemplate($event, $options = [])
    {
        ...
        if ($event == 'AlertNotValidatedTypology') {
            ...
            $this->data['##lang.typology.name##'] = Typology::getTypeName(1);
            ...
            foreach ($options['items'] as $id => $item) {
                ...
                $tmp['##typology.error##'] = Typology_Item::displayErrors($item['error'], false);
                $tmp['##typology.url##'] = urldecode($CFG_GLPI["url_base"] . "/index.php?redirect=GlpiPlugin\Typology\Typology_"
                ...
                $tmp['##typology.itemlocation##'] = Dropdown::getDropdownName(
                    "glpi_locations",
    ...
    public function getTags()
    {
        ...
        $tags = ['typology.name'             => Typology::getTypeName(1),
    ...
    public static function install()
    {
        ...
        $query_id     = "SELECT `id`
                       ...
                       WHERE `itemtype`='GlpiPlugin\\Typology\\Typology'
