...
class TypologyCriteria extends CommonDBTM
{
    ...
    **/
    function defineTabs($options = [])
    {
        ...
        $this->addStandardTab(TypologyCriteriaDefinition::class, $ong, $options);
    ...
    public static function showForTypology(Typology $typo, $showAdd = true)
    {
        ...
        if ($canedit) {
            if ($showAdd) {
                ...
                TypologyCriteria::dropdownItemtype();
           ...
           //                     action=\"../ajax/massiveaction.php\">";
            ...
            if (!empty($criterias)) {
                ...
                foreach ($criterias as $criteria) {
                    ...
                    if ($showAdd) {
                        echo "<tr><th colspan=$colspan>" . TypologyCriteria::getTypeName(1) . "</th>";
                    } else {
                    ...
                    echo "<th class='center b'>" . TypologyCriteriaDefinition::getTypeName(2) . "</th>";
                    echo "</tr>";
    ...
    **/
    function showForm($ID, $options = [])
    {
        ...
        echo "<td>" . Typology::getTypeName(1) . "</td>";
        echo "<td>";
        echo $typo->getLink();
        echo "</td>";
    ...
    **/
    function getSpecificMassiveActions($checkitem = null)
    {
        ...
        if ($isadmin) {
            $actions['GlpiPlugin\Typology\TypologyCriteria' . MassiveAction::CLASS_ACTION_SEPARATOR . 'deleteAll'] = _sx('button', 'Delete permanently');
            $actions['GlpiPlugin\Typology\TypologyCriteria' . MassiveAction::CLASS_ACTION_SEPARATOR . 'updateAll'] = _sx('button', 'Upgrade');
        }
        ...
        switch ($ma->getAction()) {
            ...
            case "updateAll":
                ...
                Ajax::updateItemOnSelectEvent(
                    ...
                    PLUGIN_TYPOLOGY_WEBDIR . "/ajax/dropdownMassiveActionField.php",
                    $params
                );
